...
describe('microsoft', async function () {
    ...
    it('Тест, что в шапке работает ссылка на каталог', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что в шапке работает ссылка на условия доставки', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что в шапке работает ссылка на контакты', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что в шапке работает ссылка на корзину', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что в шапке работает ссылка на главную', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что Главная имеет статическое содержимое', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что страница Доставки имеет статическое содержимое', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что страница Контактов имеет статическое содержимое', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('В пустой корзине есть ссылка на каталог, она работает и переводит на каталог', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Кнопка очистить корзину удаляет элементы из корзины', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что в детализированной карточке товара корректно присутствует информация о товаре', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что форма корректно отправляет данные и выдает корректный ответ', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('Тест, что по нажатии на кнопку добавить в корзину - товар должен добавиться в корзину', async function ({
        browser,
    }) {
        const puppeteer = await browser.getPuppeteer();
        const [page] = await puppeteer.pages();
    ...
    it('В каталоге должны корректно отображаться названия продуктов', async ({
        browser,
    }) => {
